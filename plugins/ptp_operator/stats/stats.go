...
func (s *Stats) reset() { //nolint:unused
	...
	s.lastOffset = 0
	s.offsetSource = ""
	s.isClockClassSet = false
	s.isLastSyncStateSet = false
	s.isLastOffsetSet = false
}
