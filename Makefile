...
IMG ?= quay.io/jacding/cloud-event-proxy:4.21
CONSUMER_IMG ?= quay.io/jacding/cloud-event-consumer:latest
...
deploy-consumer: kustomize ## Deploy consumer with authentication
	...
	@CLUSTER_NAME=${CLUSTER_NAME:-openshift.local} ./examples/manifests/auth/setup-secrets.sh
